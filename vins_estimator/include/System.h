...
public:
    ...
    void PubImage0Data(double dStampSec, cv::Mat &img);

    void PubImage1Data(double dStampSec, cv::Mat &img);
...
//    FeatureTracker trackerData[NUM_OF_CAM];
    ...
    std::queue<pair<double, cv::Mat>> img0_buf;
    std::queue<pair<double, cv::Mat>> img1_buf;
