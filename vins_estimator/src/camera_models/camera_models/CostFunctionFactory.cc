...
class ReprojectionError1
{
    ...
    // variables: camera_models intrinsics and camera_models extrinsics
    template< typename T >
    ...
    // variables: camera_models-odometry transforms and odometry poses
    template< typename T >
...
// variables: camera_models extrinsics, 3D point
template< class CameraT >
...
class ReprojectionError3
{
    ...
    // variables: camera_models intrinsics, camera_models-to-odometry transform,
    ...
    // variables: camera_models-to-odometry transform, 3D point
    template< typename T >
    ...
    // variables: camera_models-to-odometry transform, odometry extrinsics, 3D point
    template< typename T >
    bool operator( )( const T* const q_cam_odo,
                      const T* const t_cam_odo,
                      const T* const p_odo,
    ...
    // observed camera_models-odometry transform
